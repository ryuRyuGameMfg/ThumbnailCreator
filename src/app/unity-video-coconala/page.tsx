...
export default function UnityVideoCoconalaPage() {
  ...
  const handleDownloadAll = useCallback(async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = 'unity_video_coconala_slides.zip';
      link.click();
  ...
  return (
    <SafeAreaContext.Provider value={showSafeArea}>
      ...
      {/* 1. 5つの特徴 */}
      <SectionTitle title="1. 5つのサービスの特徴" />
      <SlideRow>
        <SlideContainer>
