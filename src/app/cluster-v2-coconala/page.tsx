...
import { 
  ...
  FAQ2,
  FAQ3,
} from '@projects/cluster-development-v2/coconala/slides';
import { SAFE_AREA_TOP, SAFE_AREA_BOTTOM } from '@projects/cluster-development-v2/coconala/SlideWrapper';
...
export default function UnityTextCoconalaPage() {
  ...
  const handleDownloadAll = useCallback(async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = 'cluster_v2_coconala_slides.zip';
      link.click();
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-b border-gray-200 py-4 px-8 sticky top-0 z-50">
          <div className="max-w-[2400px] mx-auto flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-black text-gray-900">Clusterワールド開発 v2 (新背景) - ココナラ版</h1>
