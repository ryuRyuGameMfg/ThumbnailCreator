...
const slideInfo = [
  { name: 'features', title: '3つの特徴' },
  { name: 'usecases', title: '用途例' },
  ...
  { name: 'faq2', title: 'FAQ - 制作納品' },
  { name: 'faq3', title: 'FAQ - サポート実績' },
];

export default function ClusterCoconalaPage() {
  ...
  const handleDownloadAll = useCallback(async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = 'cluster_coconala_slides.zip';
      link.click();
  ...
  return (
    <SafeAreaContext.Provider value={showSafeArea}>
      <main className="min-h-screen bg-gray-50">
        ...
        {/* 1. 3つの特徴 */}
        <SectionTitle title="1. 3つのサービスの特徴" />
        <SlideRow>
          <SlideContainer>
        ...
        {/* 2. 用途例 */}
        <SectionTitle title="2. 幅広い用途に対応可能" />
        <SlideRow>
          <SlideContainer>
        ...
        {/* 3. 納品内容 */}
        <SectionTitle title="3. 充実なサービス内容" />
        <SlideRow>
          <SlideContainer>
      ...
      {/* 8. よくある質問 - 制作・納品 */}
      <SectionTitle title="8. よくある質問 - 制作・納品" />
      <SlideRow>
        <SlideContainer>
