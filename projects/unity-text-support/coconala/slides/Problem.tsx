...
// ========================================
// Problem (お悩み) v2 - Unityテキストサポート
// カラーレギュレーション: グラデーションブルー系
// ========================================

export function Problem() {
  const problems = [
    { num: '01', title: 'Unity開発で詰まった', desc: 'エラーが解決できず進まない' },
    { num: '02', title: '質問したいけど', desc: '時間を気にせず聞ける場所がない' },
    { num: '03', title: 'サポートが欲しい', desc: 'でも高額なサービスは使えない' },
  ];
