...
export function FAQ3() {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'ビデオチャットサポートやClusterワールド開発なども行っております。',
    },
  ];
      ...
      <div className="flex flex-col h-full font-hackgen">
        ...
        <div className="flex-1 flex flex-col gap-3.5">
          {faqs.map(({ question, answer }, index) => (
            <div
              key={index}
              className="bg-gradient-to-r from-sky-500/20 to-blue-600/20 border-2 border-sky-400/50 rounded-xl p-3.5 shadow-sm backdrop-blur"
            >
