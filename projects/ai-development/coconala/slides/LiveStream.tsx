    ...
    <SlideWrapper slideNumber={5} slideName="live">
      <div className="flex flex-col h-full font-hackgen">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <div>
            <h1 className="font-melete text-xl font-bold tracking-wider text-rose-600">
              LIVE STREAM
            </h1>
            <p className="text-[10px] text-gray-500">ライブ配信</p>
          </div>
        </div>
        {/* フロー */}
        <div className="flex-1 flex flex-col justify-center gap-2">
          <div className="bg-white border border-blue-200 rounded-lg px-3 py-2 flex items-center gap-3 shadow-sm">
            ...
            <div>
              ...
              <div className="text-sm font-bold text-gray-800">コメントが届く</div>
              <div className="text-xs text-gray-500">YouTubeから自動取得</div>
            </div>
          </div>
          <div className="bg-white border border-blue-200 rounded-lg px-3 py-2 flex items-center gap-3 shadow-sm">
            ...
            <div>
              ...
              <div className="text-sm font-bold text-gray-800">AIが返答を生成</div>
              <div className="text-xs text-gray-500">AI + 音声合成</div>
            </div>
          </div>
          <div className="bg-white border border-blue-200 rounded-lg px-3 py-2 flex items-center gap-3 shadow-sm">
            ...
            <div>
              ...
              <div className="text-sm font-bold text-gray-800">キャラが配信</div>
              <div className="text-xs text-gray-500">24時間無人で自動応答</div>
            </div>
          </div>
        </div>
        {/* 利用シーン */}
        <div className="flex gap-1.5 mt-2">
          <div className="flex-1 bg-white border border-blue-200 rounded-lg px-2 py-1.5 flex items-center gap-1.5">
            ...
            <span className="text-xs font-bold text-gray-700">24時間FAQ</span>
          </div>
          <div className="flex-1 bg-white border border-blue-200 rounded-lg px-2 py-1.5 flex items-center gap-1.5">
            <Sparkles className="w-4 h-4 text-blue-600" />
            <span className="text-xs font-bold text-gray-700">占いVTuber</span>
          </div>
          <div className="flex-1 bg-white border border-blue-200 rounded-lg px-2 py-1.5 flex items-center gap-1.5">
            <MessageSquare className="w-4 h-4 text-blue-600" />
            <span className="text-xs font-bold text-gray-700">雑談VTuber</span>
          </div>
        </div>
      </div>
    </SlideWrapper>
