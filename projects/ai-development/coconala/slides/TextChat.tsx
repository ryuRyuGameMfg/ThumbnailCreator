...
export function TextChat() {
  return (
    <SlideWrapper slideNumber={7} slideName="chat">
      <div className="flex flex-col h-full font-hackgen">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <div>
            <h1 className="font-melete text-xl font-bold tracking-wider text-amber-600">
              TEXT CHAT
            </h1>
            <p className="text-[10px] text-gray-500">テキストチャット</p>
          </div>
        </div>
        {/* フロー */}
        <div className="flex-1 flex flex-col justify-center gap-2">
          <div className="bg-white border border-blue-200 rounded-lg px-3 py-2 flex items-center gap-3 shadow-sm">
            ...
            <div>
              ...
              <div className="text-sm font-bold text-gray-800">質問を送信</div>
              <div className="text-xs text-gray-500">テキストで入力</div>
            </div>
          </div>
          <div className="bg-white border border-blue-200 rounded-lg px-3 py-2 flex items-center gap-3 shadow-sm">
            ...
            <div>
              ...
              <div className="text-sm font-bold text-gray-800">AIが理解・処理</div>
              <div className="text-xs text-gray-500">AIで回答生成</div>
            </div>
          </div>
          <div className="bg-white border border-blue-200 rounded-lg px-3 py-2 flex items-center gap-3 shadow-sm">
            ...
            <div>
              ...
              <div className="text-sm font-bold text-gray-800">回答を表示</div>
              <div className="text-xs text-gray-500">キャラが返答</div>
            </div>
          </div>
        </div>
        {/* 利用シーン */}
