...
// ========================================
// Problem (お悩み) v2 - Unityビデオサポート
// カラーレギュレーション: グラデーションブルー系
// ========================================

export function Problem() {
  const problems = [
    { num: '01', title: 'バグが解決できない', desc: '画面を見せながら相談したい' },
    { num: '02', title: '開発のコツを知りたい', desc: 'でもテキストでは伝わらない' },
    { num: '03', title: 'リアルタイムで質問したい', desc: 'でも気軽に相談できる人がいない' },
  ];
